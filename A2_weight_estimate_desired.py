...
W_crew = num_pilot * avg_wt_person  # kg
...
# Mission Parameters
R = 1000                 # nmi (Range) [RFP requests 200 nmi combat radius]
...
t_dash_a2a = 5/60    # hr (2 min dash time for air to air combat)
V_dash_a2a = 589*2.0 # knots (Speed) [Using Ma = 1.6 dash speed at 30,000 ftfor Air to Air Combat]
...
V_dash_strike = 661*0.90 # knots (Speed) [Using Ma = .85 dash speed at SL for Strike]
